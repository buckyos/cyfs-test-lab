...
class BufferWriter {
    ...
    render() {
        ...
        (0, assert_1.default)(off === data.length, `off = ${off} data.length = ${data.length}`);
        this.destroy();
        return data;
    }
    /**
    ...
    writeHash(value) {
        if (typeof value !== 'string') {
            (0, assert_1.default)(value.length === 32);
            this.writeBytes(value);
            return;
        }
        (0, assert_1.default)(value.length === 64);
