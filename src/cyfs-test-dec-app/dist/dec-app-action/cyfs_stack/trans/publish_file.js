...
exports.PublishFileAction = void 0;
const action_1 = require("../../action");
const common_1 = require("../../../common");
const cyfs_driver_client_1 = require("../../../cyfs-driver-client");
class PublishFileAction extends action_1.BaseAction {
    ...
    async run(req) {
        ...
        if (info1.err) {
            ...
            return { err: common_1.ErrorCode.succ, log: "success", resp: { file_id: info1.unwrap().file_id, file_name, file_path: file_path, md5 } };
        }
    }
}
exports.PublishFileAction = PublishFileAction;
