...
exports.BuildTransGroupTree = void 0;
 ...
 */
class BuildTransGroupTree extends action_1.BaseAction {
    async start(req) {
    ...
    async run(req) {
        ...
        for (let task of req.task_list) {
            ...
            task_running_list.push(prepare_file_task_1.PrepareFileTask.create_by_parent(this.action, this.logger).action.start({
...
exports.BuildTransGroupTree = BuildTransGroupTree;
