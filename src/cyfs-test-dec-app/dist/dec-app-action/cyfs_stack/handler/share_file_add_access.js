...
exports.ShareFileAddAccessRequest = void 0;
...
*/
class ShareFileAddAccessRequest extends action_1.BaseAction {
    ...
    async run(req) {
        ...
        let handler_request = dec_app_base_1.HandlerRequestObject.create(local.local_device_id().object_id, dec_app_base_1.HandlerType.ShareFileAddAccess, this.action.action_id, JSON.stringify(request), new Uint8Array(0));
        ...
        let resp = JSON.parse(response_object.request_json);
        if (!resp.ShareFileAddAccessHandlerResp) {
            return { err: common_1.ErrorCode.invalidParam, log: "error response data", resp: resp.ShareFileAddAccessHandlerResp };
        }
        return { err: common_1.ErrorCode.succ, log: "success", resp: resp.ShareFileAddAccessHandlerResp };
    }
}
exports.ShareFileAddAccessRequest = ShareFileAddAccessRequest;
