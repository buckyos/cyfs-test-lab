...
exports.AddContextRequest = void 0;
...
*/
class AddContextRequest extends action_1.BaseAction {
    ...
    async run(req) {
        ...
        let handler_request = dec_app_base_1.HandlerRequestObject.create(local.local_device_id().object_id, dec_app_base_1.HandlerType.AddContext, this.action.action_id, JSON.stringify(request), new Uint8Array(0));
        ...
        if (!resp.AddContextHandlerResp) {
            return { err: common_1.ErrorCode.invalidParam, log: "error response data", resp: resp.AddContextHandlerResp };
        }
        return { err: common_1.ErrorCode.succ, log: "success", resp: resp.AddContextHandlerResp };
    }
}
exports.AddContextRequest = AddContextRequest;
