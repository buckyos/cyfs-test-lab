...
*/
class UpdateContextRequest extends action_1.BaseAction {
    ...
    async run(req) {
        ...
        let handler_request = dec_app_base_1.HandlerRequestObject.create(local.local_device_id().object_id, dec_app_base_1.HandlerType.UpdateContext, this.action.action_id, JSON.stringify(request), new Uint8Array(0));
        ...
        if (!resp.UpdateContextHandlerResp) {
            return { err: common_1.ErrorCode.invalidParam, log: "error response data", resp: resp.UpdateContextHandlerResp };
        }
        return { err: common_1.ErrorCode.succ, log: "success", resp: resp.UpdateContextHandlerResp };
    }
}
