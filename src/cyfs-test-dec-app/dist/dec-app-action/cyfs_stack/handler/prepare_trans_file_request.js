...
exports.PrepareTransFileRequest = void 0;
...
*/
class PrepareTransFileRequest extends action_1.BaseAction {
    ...
    async run(req) {
        ...
        let handler_request = dec_app_base_1.HandlerRequestObject.create(local.local_device_id().object_id, dec_app_base_1.HandlerType.PrepareTransFile, this.action.action_id, JSON.stringify(request), new Uint8Array(0));
        ...
        return { err: common_1.ErrorCode.succ, log: "success", resp: JSON.parse(response_object.request_json).PrepareTransFileHandlerResp };
    }
}
exports.PrepareTransFileRequest = PrepareTransFileRequest;
