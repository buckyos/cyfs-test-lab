...
exports.PostHandlerRequestObject = void 0;
 ...
 *
 */
class PostHandlerRequestObject extends action_1.BaseAction {
    ...
    async run(req) {
        ...
        return { err: common_1.ErrorCode.succ, log: "success", resp: JSON.parse(response_object.request_json) };
    }
}
exports.PostHandlerRequestObject = PostHandlerRequestObject;
