...
export class IsolateEnvInsertWithKey extends BaseAction implements ActionAbstract {
    ...
    static create_by_parent(action: Action): { err: number, action?: IsolateEnvInsertWithKey } {
