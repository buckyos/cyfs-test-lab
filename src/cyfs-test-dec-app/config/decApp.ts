...
export const NIGHTLY_DEC_ID = "9tGpLNnQV8jsncjqRtRfreAFZEQaYnp431KJHaNZ6KRB";
export const NIGHTLY_SERVICE_OOD = "5bnZHzYHCUJFRxXBAPDw8727uHdS95yhFnBmoNrwm7CP";

export const BETA_DEC_ID = "9tGpLNnQV8jsncjqRtRfreAFZEQaYnp431KJHaNZ6KRB";
export const BETA_SERVICE_OOD = "5bnZHzYHCUJFRxXBAPDw8727uHdS95yhFnBmoNrwm7CP";

export const  APP_NAME = "cyfs_stack_test"
export const DEC_ID = cyfs.ObjectId.from_base_58(BETA_DEC_ID).unwrap();
