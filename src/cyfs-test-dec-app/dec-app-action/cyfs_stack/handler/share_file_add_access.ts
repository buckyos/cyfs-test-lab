...
import {HandlerApi,HandlerRequestObject,HandlerRequestObjectDecoder,HandlerType,ShareFileAddAccessHandlerReq,ShareFileAddAccessHandlerResp } from "../../../dec-app-base"
...
export class ShareFileAddAccessRequest extends BaseAction implements ActionAbstract {
    static create_by_parent(action:Action): {err:number,action?:ShareFileAddAccessRequest}{
