...
import {HandlerApi,HandlerRequestObject,HandlerRequestObjectDecoder,TransFileHandlerReq,HandlerType,TransFileHandlerResp} from "../../../dec-app-base"
...
export class TransFileRequest extends BaseAction implements ActionAbstract {
    static create_by_parent(action:Action): {err:number,action?:TransFileRequest}{
