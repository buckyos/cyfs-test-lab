...
import {CyfsStackDriverManager} from "../../../cyfs-driver-client/driver_manager"
...
describe("SharedCyfsStack util相关接口测试", function () {
    ...
    this.beforeAll(async function () {
        ...
        let driver_manage =  CyfsStackDriverManager.createInstance();
        await driver_manage.init();
        await driver_manage.load_driver_from_config();
