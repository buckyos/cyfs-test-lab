...
describe("SharedCyfsStack util相关接口测试", function () {
    ...
    describe("测试模拟器+真机集成",async()=>{
        it("测试模拟器+真机集成",async()=>{
            ...
            // 指定获取
            let stack1 = stack_manager.get_cyfs_satck("zone1_ood",dec_app_1.to_base_58()).stack!;
            let stack2 = stack_manager.get_cyfs_satck("zone1_device1",dec_app_2.to_base_58()).stack!;
