...
export class AppListExDescTypeInfo extends DescTypeInfo {
    obj_type(): number;
    sub_desc_type(): SubDescType;
}
export class AppListExDesc extends ProtobufDescContent<protos.IAppListExDesc> {
    id: string;
    constructor(id: string);
    type_info(): DescTypeInfo;
    try_to_proto(): BuckyResult<protos.IAppListExDesc>;
}
export class AppListExDescDecoder extends ProtobufDescContentDecoder<AppListExDesc, protos.IAppListExDesc> {
    constructor();
    type_info(): DescTypeInfo;
    try_from_proto(value: protos.IAppListExDesc): BuckyResult<AppListExDesc>;
}
export class AppListExBodyContent extends ProtobufBodyContent<protos.IAppListExBody> {
    list: BuckyHashSet<DecAppId>;
    constructor(list: BuckyHashSet<DecAppId>);
    try_to_proto(): BuckyResult<protos.IAppListExBody>;
}
export class AppListExBodyContentDecoder extends ProtobufBodyContentDecoder<AppListExBodyContent, protos.IAppListExBody> {
    constructor();
    try_from_proto(value: protos.IAppListExBody): BuckyResult<AppListExBodyContent>;
}
export class AppListExBuilder extends NamedObjectBuilder<AppListExDesc, AppListExBodyContent> {
}
export class AppListExId extends NamedObjectId<AppListExDesc, AppListExBodyContent> {
    constructor(id: ObjectId);
    static default(): AppListExId;
    static from_base_58(s: string): BuckyResult<AppListExId>;
    static try_from_object_id(id: ObjectId): BuckyResult<AppListExId>;
}
export class AppListExIdDecoder extends NamedObjectIdDecoder<AppListExDesc, AppListExBodyContent> {
    constructor();
}
export class AppListEx extends NamedObject<AppListExDesc, AppListExBodyContent> {
    static create(owner: ObjectId, id: string): AppListEx;
...
export class AppListExDecoder extends NamedObjectDecoder<AppListExDesc, AppListExBodyContent, AppListEx> {
    constructor();
    static create(): AppListExDecoder;
}
...
export class AppLocalStatusExDescTypeInfo extends DescTypeInfo {
    obj_type(): number;
    sub_desc_type(): SubDescType;
}
export class AppLocalStatusExDesc extends ProtobufDescContent<protos.IAppLocalStatusExDesc> {
    id: DecAppId;
    constructor(id: DecAppId);
    type_info(): DescTypeInfo;
    try_to_proto(): BuckyResult<protos.IAppLocalStatusExDesc>;
}
export class AppLocalStatusExDescDecoder extends ProtobufDescContentDecoder<AppLocalStatusExDesc, protos.IAppLocalStatusExDesc> {
    constructor();
    type_info(): DescTypeInfo;
    try_from_proto(value: protos.IAppLocalStatusExDesc): BuckyResult<AppLocalStatusExDesc>;
}
export enum AppLocalStatusExCode {
    Init = 0,
    Installing = 1,
    InstallFailed = 3,
    NoService = 4,
...
export class AppLocalStatusExBodyContent extends ProtobufBodyContent<protos.IAppLocalStatusExBody> {
    status: AppLocalStatusExCode;
    ...
    constructor(status: AppLocalStatusExCode, permissions?: BuckyHashMap<BuckyString, PermissionNode>, quota?: Map<AppQuotaType, JSBI>, last_status_update_time?: JSBI, version?: string, web_dir?: DirId, sub_error?: SubErrorCode);
    try_to_proto(): BuckyResult<protos.IAppLocalStatusExBody>;
}
export class AppLocalStatusExBodyContentDecoder extends ProtobufBodyContentDecoder<AppLocalStatusExBodyContent, protos.IAppLocalStatusExBody> {
    constructor();
    try_from_proto(value: protos.IAppLocalStatusExBody): BuckyResult<AppLocalStatusExBodyContent>;
}
export class AppLocalStatusExBuilder extends NamedObjectBuilder<AppLocalStatusExDesc, AppLocalStatusExBodyContent> {
}
export class AppLocalStatusExId extends NamedObjectId<AppLocalStatusExDesc, AppLocalStatusExBodyContent> {
    constructor(id: ObjectId);
    static default(): AppLocalStatusExId;
    static from_base_58(s: string): BuckyResult<AppLocalStatusExId>;
    static try_from_object_id(id: ObjectId): BuckyResult<AppLocalStatusExId>;
}
export class AppLocalStatusExIdDecoder extends NamedObjectIdDecoder<AppLocalStatusExDesc, AppLocalStatusExBodyContent> {
    constructor();
}
export class AppLocalStatusEx extends NamedObject<AppLocalStatusExDesc, AppLocalStatusExBodyContent> {
    static create(owner: ObjectId, id: DecAppId): AppLocalStatusEx;
    app_id(): DecAppId;
    webdir(): DirId | undefined;
    status(): AppLocalStatusExCode;
...
export class AppLocalStatusExDecoder extends NamedObjectDecoder<AppLocalStatusExDesc, AppLocalStatusExBodyContent, AppLocalStatusEx> {
    constructor();
    static create(): AppLocalStatusExDecoder;
}
...
export class AppCmdDesc extends ProtobufDescContent<protos.IAppCmdDesc> {
    id: DecAppId;
    cmd: AppCmdCode;
    constructor(id: DecAppId, cmd: AppCmdCode);
    type_info(): DescTypeInfo;
    try_to_proto(): BuckyResult<protos.IAppCmdDesc>;
}
export class AppCmdDescDecoder extends ProtobufDescContentDecoder<AppCmdDesc, protos.IAppCmdDesc> {
    constructor();
    type_info(): DescTypeInfo;
    try_from_proto(value: protos.IAppCmdDesc): BuckyResult<AppCmdDesc>;
}
...
export class AppCmdBodyContent extends ProtobufBodyContent<protos.IAppCmdBody> {
    params: Map<string, string>;
    constructor(params: Map<string, string>);
    try_to_proto(): BuckyResult<protos.IAppCmdBody>;
}
export class AppCmdBodyContentDecoder extends ProtobufBodyContentDecoder<AppCmdBodyContent, protos.IAppCmdBody> {
    constructor();
    try_from_proto(value: protos.IAppCmdBody): BuckyResult<AppCmdBodyContent>;
}
export class AppCmdBuilder extends NamedObjectBuilder<AppCmdDesc, AppCmdBodyContent> {
}
export class AppCmdId extends NamedObjectId<AppCmdDesc, AppCmdBodyContent> {
    constructor(id: ObjectId);
...
export class AppCmdIdDecoder extends NamedObjectIdDecoder<AppCmdDesc, AppCmdBodyContent> {
    constructor();
}
export class AppCmd extends NamedObject<AppCmdDesc, AppCmdBodyContent> {
    static create(owner: ObjectId, id: DecAppId, cmd: AppCmdCode, params: Map<string, string>): AppCmd;
    app_id(): DecAppId;
    cmd(): AppCmdCode;
    params(): Map<string, string>;
...
export class AppCmdDecoder extends NamedObjectDecoder<AppCmdDesc, AppCmdBodyContent, AppCmd> {
    constructor();
...
export interface ObjectStackRequestorConfig {
    ...
    root_state: ObjectStackRequestorType;
    local_cache: ObjectStackRequestorType;
}
...
export type StandardObject = Device | People | SimpleGroup | Org | AppGroup | UnionAccount | ChunkId | Dir | File | Action | ObjectMap | Contract;
...
export class TransContextDescContent extends ProtobufDescContent<protos.ITransContextDescContent> {
    constructor(dec_id: ObjectId, context_name: string);
    try_to_proto(): BuckyResult<any>;
    type_info(): DescTypeInfo;
}
export class TransContextDescContentDecoder extends ProtobufDescContentDecoder<TransContextDescContent, protos.ITransContextDescContent> {
    constructor();
    try_from_proto(value: protos.ITransContextDescContent): BuckyResult<TransContextDescContent>;
    type_info(): DescTypeInfo;
}
export class TransContextBodyContent extends ProtobufBodyContent<protos.ITransContextBodyContent> {
    constructor(ref_id: Option<ObjectId>, device_list: DeviceId[]);
    try_to_proto(): BuckyResult<protos.ITransContextBodyContent>;
}
export class TransContextBodyContentDecoder extends ProtobufBodyContentDecoder<TransContextBodyContent, protos.ITransContextBodyContent> {
    constructor();
    try_from_proto(value: protos.ITransContextBodyContent): BuckyResult<TransContextBodyContent>;
}
...
export interface IPeopleBodyContent {
        ...
        /** PeopleBodyContent ood_work_mode */
...
export class PeopleBodyContent implements IPeopleBodyContent {
        ...
        /** PeopleBodyContent _ood_work_mode. */
        _ood_work_mode?: "ood_work_mode";
...
export interface ISimpleGroupBodyContent {
        ...
        /** SimpleGroupBodyContent ood_work_mode */
        ood_work_mode?: (string|null);
}
...
export class SimpleGroupBodyContent implements ISimpleGroupBodyContent {
        ...
        /** SimpleGroupBodyContent _ood_work_mode. */
        _ood_work_mode?: "ood_work_mode";
...
export class ZoneBodyContent implements IZoneBodyContent {
        ...
        /** ZoneBodyContent _ood_work_mode. */
        _ood_work_mode?: "ood_work_mode";
...
/** Properties of an AppListExDesc. */
export interface IAppListExDesc {

        /** AppListExDesc id */
        id?: (string|null);
}

/** Represents an AppListExDesc. */
export class AppListExDesc implements IAppListExDesc {

        /**
            * Constructs a new AppListExDesc.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppListExDesc);

        /** AppListExDesc id. */
        id: string;

        /**
            * Creates a new AppListExDesc instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppListExDesc instance
            */
        static create(properties?: IAppListExDesc): AppListExDesc;

        /**
            * Encodes the specified AppListExDesc message. Does not implicitly {@link AppListExDesc.verify|verify} messages.
            * @param message AppListExDesc message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppListExDesc, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppListExDesc message, length delimited. Does not implicitly {@link AppListExDesc.verify|verify} messages.
            * @param message AppListExDesc message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppListExDesc, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppListExDesc message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppListExDesc
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppListExDesc;

        /**
            * Decodes an AppListExDesc message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppListExDesc
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppListExDesc;

        /**
            * Verifies an AppListExDesc message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppListExDesc message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppListExDesc
            */
        static fromObject(object: { [k: string]: any }): AppListExDesc;

        /**
            * Creates a plain object from an AppListExDesc message. Also converts values to other types if specified.
            * @param message AppListExDesc
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppListExDesc, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppListExDesc to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppListExItem. */
export interface IAppListExItem {

        /** AppListExItem app_id */
        app_id?: (Uint8Array|null);
}

/** Represents an AppListExItem. */
export class AppListExItem implements IAppListExItem {

        /**
            * Constructs a new AppListExItem.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppListExItem);

        /** AppListExItem app_id. */
        app_id: Uint8Array;

        /**
            * Creates a new AppListExItem instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppListExItem instance
            */
        static create(properties?: IAppListExItem): AppListExItem;

        /**
            * Encodes the specified AppListExItem message. Does not implicitly {@link AppListExItem.verify|verify} messages.
            * @param message AppListExItem message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppListExItem, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppListExItem message, length delimited. Does not implicitly {@link AppListExItem.verify|verify} messages.
            * @param message AppListExItem message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppListExItem, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppListExItem message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppListExItem
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppListExItem;

        /**
            * Decodes an AppListExItem message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppListExItem
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppListExItem;

        /**
            * Verifies an AppListExItem message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppListExItem message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppListExItem
            */
        static fromObject(object: { [k: string]: any }): AppListExItem;

        /**
            * Creates a plain object from an AppListExItem message. Also converts values to other types if specified.
            * @param message AppListExItem
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppListExItem, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppListExItem to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppListExBody. */
export interface IAppListExBody {

        /** AppListExBody list */
        list?: (IAppListExItem[]|null);
}

/** Represents an AppListExBody. */
export class AppListExBody implements IAppListExBody {

        /**
            * Constructs a new AppListExBody.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppListExBody);

        /** AppListExBody list. */
        list: IAppListExItem[];

        /**
            * Creates a new AppListExBody instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppListExBody instance
            */
        static create(properties?: IAppListExBody): AppListExBody;

        /**
            * Encodes the specified AppListExBody message. Does not implicitly {@link AppListExBody.verify|verify} messages.
            * @param message AppListExBody message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppListExBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppListExBody message, length delimited. Does not implicitly {@link AppListExBody.verify|verify} messages.
            * @param message AppListExBody message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppListExBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppListExBody message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppListExBody
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppListExBody;

        /**
            * Decodes an AppListExBody message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppListExBody
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppListExBody;

        /**
            * Verifies an AppListExBody message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppListExBody message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppListExBody
            */
        static fromObject(object: { [k: string]: any }): AppListExBody;

        /**
            * Creates a plain object from an AppListExBody message. Also converts values to other types if specified.
            * @param message AppListExBody
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppListExBody, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppListExBody to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppPermission. */
export interface IAppPermission {

        /** AppPermission permission */
        permission?: (string|null);

        /** AppPermission reason */
        reason?: (string|null);
...
/** Represents an AppPermission. */
export class AppPermission implements IAppPermission {

        /**
            * Constructs a new AppPermission.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppPermission);
        ...
        /**
            * Creates a new AppPermission instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppPermission instance
            */
        static create(properties?: IAppPermission): AppPermission;

        /**
            * Encodes the specified AppPermission message. Does not implicitly {@link AppPermission.verify|verify} messages.
            * @param message AppPermission message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppPermission, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppPermission message, length delimited. Does not implicitly {@link AppPermission.verify|verify} messages.
            * @param message AppPermission message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppPermission, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppPermission message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppPermission
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppPermission;

        /**
            * Decodes an AppPermission message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppPermission
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppPermission;

        /**
            * Verifies an AppPermission message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppPermission message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppPermission
            */
        static fromObject(object: { [k: string]: any }): AppPermission;

        /**
            * Creates a plain object from an AppPermission message. Also converts values to other types if specified.
            * @param message AppPermission
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppPermission, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppPermission to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppQuota. */
...
/** Represents an AppQuota. */
export class AppQuota implements IAppQuota {

        /**
            * Constructs a new AppQuota.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppQuota);
        ...
        /**
            * Creates a new AppQuota instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppQuota instance
            */
        static create(properties?: IAppQuota): AppQuota;

        /**
            * Encodes the specified AppQuota message. Does not implicitly {@link AppQuota.verify|verify} messages.
            * @param message AppQuota message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppQuota, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppQuota message, length delimited. Does not implicitly {@link AppQuota.verify|verify} messages.
            * @param message AppQuota message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppQuota, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppQuota message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppQuota
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppQuota;

        /**
            * Decodes an AppQuota message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppQuota
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppQuota;

        /**
            * Verifies an AppQuota message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppQuota message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppQuota
            */
        static fromObject(object: { [k: string]: any }): AppQuota;

        /**
            * Creates a plain object from an AppQuota message. Also converts values to other types if specified.
            * @param message AppQuota
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppQuota, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppQuota to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppLocalStatusExDesc. */
export interface IAppLocalStatusExDesc {

        /** AppLocalStatusExDesc id */
        id?: (Uint8Array|null);
}

/** Represents an AppLocalStatusExDesc. */
export class AppLocalStatusExDesc implements IAppLocalStatusExDesc {

        /**
            * Constructs a new AppLocalStatusExDesc.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppLocalStatusExDesc);

        /** AppLocalStatusExDesc id. */
        id: Uint8Array;

        /**
            * Creates a new AppLocalStatusExDesc instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppLocalStatusExDesc instance
            */
        static create(properties?: IAppLocalStatusExDesc): AppLocalStatusExDesc;

        /**
            * Encodes the specified AppLocalStatusExDesc message. Does not implicitly {@link AppLocalStatusExDesc.verify|verify} messages.
            * @param message AppLocalStatusExDesc message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppLocalStatusExDesc, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppLocalStatusExDesc message, length delimited. Does not implicitly {@link AppLocalStatusExDesc.verify|verify} messages.
            * @param message AppLocalStatusExDesc message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppLocalStatusExDesc, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppLocalStatusExDesc message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppLocalStatusExDesc
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppLocalStatusExDesc;

        /**
            * Decodes an AppLocalStatusExDesc message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppLocalStatusExDesc
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppLocalStatusExDesc;

        /**
            * Verifies an AppLocalStatusExDesc message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppLocalStatusExDesc message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppLocalStatusExDesc
            */
        static fromObject(object: { [k: string]: any }): AppLocalStatusExDesc;

        /**
            * Creates a plain object from an AppLocalStatusExDesc message. Also converts values to other types if specified.
            * @param message AppLocalStatusExDesc
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppLocalStatusExDesc, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppLocalStatusExDesc to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppLocalStatusExBody. */
export interface IAppLocalStatusExBody {

        /** AppLocalStatusExBody status */
        status?: (number|null);

        /** AppLocalStatusExBody version */
        version?: (string|null);

        /** AppLocalStatusExBody web_dir */
        web_dir?: (Uint8Array|null);

        /** AppLocalStatusExBody permissions */
        permissions?: (IAppPermission[]|null);

        /** AppLocalStatusExBody quota */
        quota?: (IAppQuota[]|null);

        /** AppLocalStatusExBody last_status_update_time */
        last_status_update_time?: (number|Long|null);

        /** AppLocalStatusExBody sub_error */
        sub_error?: (number|null);
}

/** Represents an AppLocalStatusExBody. */
export class AppLocalStatusExBody implements IAppLocalStatusExBody {

        /**
            * Constructs a new AppLocalStatusExBody.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppLocalStatusExBody);
        ...
        /** AppLocalStatusExBody last_status_update_time. */
        last_status_update_time: (number|Long);

        /** AppLocalStatusExBody sub_error. */
        sub_error: number;

        /** AppLocalStatusExBody _version. */
        _version?: "version";

        /** AppLocalStatusExBody _web_dir. */
        _web_dir?: "web_dir";

        /**
            * Creates a new AppLocalStatusExBody instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppLocalStatusExBody instance
            */
        static create(properties?: IAppLocalStatusExBody): AppLocalStatusExBody;

        /**
            * Encodes the specified AppLocalStatusExBody message. Does not implicitly {@link AppLocalStatusExBody.verify|verify} messages.
            * @param message AppLocalStatusExBody message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppLocalStatusExBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppLocalStatusExBody message, length delimited. Does not implicitly {@link AppLocalStatusExBody.verify|verify} messages.
            * @param message AppLocalStatusExBody message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppLocalStatusExBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppLocalStatusExBody message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppLocalStatusExBody
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppLocalStatusExBody;

        /**
            * Decodes an AppLocalStatusExBody message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppLocalStatusExBody
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppLocalStatusExBody;

        /**
            * Verifies an AppLocalStatusExBody message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppLocalStatusExBody message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppLocalStatusExBody
            */
        static fromObject(object: { [k: string]: any }): AppLocalStatusExBody;

        /**
            * Creates a plain object from an AppLocalStatusExBody message. Also converts values to other types if specified.
            * @param message AppLocalStatusExBody
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppLocalStatusExBody, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppLocalStatusExBody to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppCmdDesc. */
export interface IAppCmdDesc {
...
/** Represents an AppCmdDesc. */
export class AppCmdDesc implements IAppCmdDesc {

        /**
            * Constructs a new AppCmdDesc.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppCmdDesc);
        ...
        /**
            * Creates a new AppCmdDesc instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppCmdDesc instance
            */
        static create(properties?: IAppCmdDesc): AppCmdDesc;

        /**
            * Encodes the specified AppCmdDesc message. Does not implicitly {@link AppCmdDesc.verify|verify} messages.
            * @param message AppCmdDesc message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppCmdDesc, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppCmdDesc message, length delimited. Does not implicitly {@link AppCmdDesc.verify|verify} messages.
            * @param message AppCmdDesc message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppCmdDesc, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppCmdDesc message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppCmdDesc
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppCmdDesc;

        /**
            * Decodes an AppCmdDesc message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppCmdDesc
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppCmdDesc;

        /**
            * Verifies an AppCmdDesc message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppCmdDesc message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppCmdDesc
            */
        static fromObject(object: { [k: string]: any }): AppCmdDesc;

        /**
            * Creates a plain object from an AppCmdDesc message. Also converts values to other types if specified.
            * @param message AppCmdDesc
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppCmdDesc, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppCmdDesc to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppCmdParam. */
export interface IAppCmdParam {
...
/** Represents an AppCmdParam. */
export class AppCmdParam implements IAppCmdParam {

        /**
            * Constructs a new AppCmdParam.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppCmdParam);
        ...
        /**
            * Creates a new AppCmdParam instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppCmdParam instance
            */
        static create(properties?: IAppCmdParam): AppCmdParam;

        /**
            * Encodes the specified AppCmdParam message. Does not implicitly {@link AppCmdParam.verify|verify} messages.
            * @param message AppCmdParam message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppCmdParam, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppCmdParam message, length delimited. Does not implicitly {@link AppCmdParam.verify|verify} messages.
            * @param message AppCmdParam message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppCmdParam, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppCmdParam message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppCmdParam
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppCmdParam;

        /**
            * Decodes an AppCmdParam message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppCmdParam
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppCmdParam;

        /**
            * Verifies an AppCmdParam message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppCmdParam message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppCmdParam
            */
        static fromObject(object: { [k: string]: any }): AppCmdParam;

        /**
            * Creates a plain object from an AppCmdParam message. Also converts values to other types if specified.
            * @param message AppCmdParam
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppCmdParam, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppCmdParam to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppCmdBody. */
export interface IAppCmdBody {

        /** AppCmdBody param */
        param?: (IAppCmdParam[]|null);
}

/** Represents an AppCmdBody. */
export class AppCmdBody implements IAppCmdBody {

        /**
            * Constructs a new AppCmdBody.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppCmdBody);

        /** AppCmdBody param. */
        param: IAppCmdParam[];

        /**
            * Creates a new AppCmdBody instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppCmdBody instance
            */
        static create(properties?: IAppCmdBody): AppCmdBody;

        /**
            * Encodes the specified AppCmdBody message. Does not implicitly {@link AppCmdBody.verify|verify} messages.
            * @param message AppCmdBody message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppCmdBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppCmdBody message, length delimited. Does not implicitly {@link AppCmdBody.verify|verify} messages.
            * @param message AppCmdBody message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppCmdBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppCmdBody message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppCmdBody
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppCmdBody;

        /**
            * Decodes an AppCmdBody message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppCmdBody
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppCmdBody;

        /**
            * Verifies an AppCmdBody message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppCmdBody message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppCmdBody
            */
        static fromObject(object: { [k: string]: any }): AppCmdBody;

        /**
            * Creates a plain object from an AppCmdBody message. Also converts values to other types if specified.
            * @param message AppCmdBody
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppCmdBody, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppCmdBody to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppCmdListDesc. */
export interface IAppCmdListDesc {

        /** AppCmdListDesc id */
        id?: (string|null);
}

/** Represents an AppCmdListDesc. */
export class AppCmdListDesc implements IAppCmdListDesc {

        /**
            * Constructs a new AppCmdListDesc.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppCmdListDesc);

        /** AppCmdListDesc id. */
        id: string;

        /**
            * Creates a new AppCmdListDesc instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppCmdListDesc instance
            */
        static create(properties?: IAppCmdListDesc): AppCmdListDesc;

        /**
            * Encodes the specified AppCmdListDesc message. Does not implicitly {@link AppCmdListDesc.verify|verify} messages.
            * @param message AppCmdListDesc message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppCmdListDesc, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppCmdListDesc message, length delimited. Does not implicitly {@link AppCmdListDesc.verify|verify} messages.
            * @param message AppCmdListDesc message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppCmdListDesc, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppCmdListDesc message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppCmdListDesc
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppCmdListDesc;

        /**
            * Decodes an AppCmdListDesc message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppCmdListDesc
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppCmdListDesc;

        /**
            * Verifies an AppCmdListDesc message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppCmdListDesc message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppCmdListDesc
            */
        static fromObject(object: { [k: string]: any }): AppCmdListDesc;

        /**
            * Creates a plain object from an AppCmdListDesc message. Also converts values to other types if specified.
            * @param message AppCmdListDesc
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppCmdListDesc, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppCmdListDesc to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppCmdListItem. */
export interface IAppCmdListItem {

        /** AppCmdListItem cmd */
        cmd?: (Uint8Array|null);

        /** AppCmdListItem retry_count */
        retry_count?: (number|null);
}

/** Represents an AppCmdListItem. */
export class AppCmdListItem implements IAppCmdListItem {

        /**
            * Constructs a new AppCmdListItem.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppCmdListItem);
        ...
        /**
            * Creates a new AppCmdListItem instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppCmdListItem instance
            */
        static create(properties?: IAppCmdListItem): AppCmdListItem;

        /**
            * Encodes the specified AppCmdListItem message. Does not implicitly {@link AppCmdListItem.verify|verify} messages.
            * @param message AppCmdListItem message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppCmdListItem, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppCmdListItem message, length delimited. Does not implicitly {@link AppCmdListItem.verify|verify} messages.
            * @param message AppCmdListItem message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppCmdListItem, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppCmdListItem message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppCmdListItem
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppCmdListItem;

        /**
            * Decodes an AppCmdListItem message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppCmdListItem
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppCmdListItem;

        /**
            * Verifies an AppCmdListItem message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppCmdListItem message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppCmdListItem
            */
        static fromObject(object: { [k: string]: any }): AppCmdListItem;

        /**
            * Creates a plain object from an AppCmdListItem message. Also converts values to other types if specified.
            * @param message AppCmdListItem
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppCmdListItem, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppCmdListItem to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of an AppCmdListBody. */
export interface IAppCmdListBody {

        /** AppCmdListBody list */
        list?: (IAppCmdListItem[]|null);
}

/** Represents an AppCmdListBody. */
export class AppCmdListBody implements IAppCmdListBody {

        /**
            * Constructs a new AppCmdListBody.
            * @param [properties] Properties to set
            */
        constructor(properties?: IAppCmdListBody);

        /** AppCmdListBody list. */
        list: IAppCmdListItem[];

        /**
            * Creates a new AppCmdListBody instance using the specified properties.
            * @param [properties] Properties to set
            * @returns AppCmdListBody instance
            */
        static create(properties?: IAppCmdListBody): AppCmdListBody;

        /**
            * Encodes the specified AppCmdListBody message. Does not implicitly {@link AppCmdListBody.verify|verify} messages.
            * @param message AppCmdListBody message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: IAppCmdListBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified AppCmdListBody message, length delimited. Does not implicitly {@link AppCmdListBody.verify|verify} messages.
            * @param message AppCmdListBody message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: IAppCmdListBody, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes an AppCmdListBody message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns AppCmdListBody
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): AppCmdListBody;

        /**
            * Decodes an AppCmdListBody message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns AppCmdListBody
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): AppCmdListBody;

        /**
            * Verifies an AppCmdListBody message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates an AppCmdListBody message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns AppCmdListBody
            */
        static fromObject(object: { [k: string]: any }): AppCmdListBody;

        /**
            * Creates a plain object from an AppCmdListBody message. Also converts values to other types if specified.
            * @param message AppCmdListBody
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: AppCmdListBody, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this AppCmdListBody to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}
...
/** Properties of a TransContextDescContent. */
export interface ITransContextDescContent {

        /** TransContextDescContent dec_id */
        dec_id?: (Uint8Array|null);

        /** TransContextDescContent context_name */
        context_name?: (string|null);
}

/** Represents a TransContextDescContent. */
export class TransContextDescContent implements ITransContextDescContent {

        /**
            * Constructs a new TransContextDescContent.
            * @param [properties] Properties to set
            */
        constructor(properties?: ITransContextDescContent);
        ...
        /**
            * Creates a new TransContextDescContent instance using the specified properties.
            * @param [properties] Properties to set
            * @returns TransContextDescContent instance
            */
        static create(properties?: ITransContextDescContent): TransContextDescContent;

        /**
            * Encodes the specified TransContextDescContent message. Does not implicitly {@link TransContextDescContent.verify|verify} messages.
            * @param message TransContextDescContent message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: ITransContextDescContent, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified TransContextDescContent message, length delimited. Does not implicitly {@link TransContextDescContent.verify|verify} messages.
            * @param message TransContextDescContent message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: ITransContextDescContent, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes a TransContextDescContent message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns TransContextDescContent
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): TransContextDescContent;

        /**
            * Decodes a TransContextDescContent message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns TransContextDescContent
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): TransContextDescContent;

        /**
            * Verifies a TransContextDescContent message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates a TransContextDescContent message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns TransContextDescContent
            */
        static fromObject(object: { [k: string]: any }): TransContextDescContent;

        /**
            * Creates a plain object from a TransContextDescContent message. Also converts values to other types if specified.
            * @param message TransContextDescContent
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: TransContextDescContent, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this TransContextDescContent to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}

/** Properties of a TransContextBodyContent. */
export interface ITransContextBodyContent {

        /** TransContextBodyContent ref_id */
        ref_id?: (Uint8Array|null);

        /** TransContextBodyContent device_list */
        device_list?: (Uint8Array[]|null);
}

/** Represents a TransContextBodyContent. */
export class TransContextBodyContent implements ITransContextBodyContent {

        /**
            * Constructs a new TransContextBodyContent.
            * @param [properties] Properties to set
            */
        constructor(properties?: ITransContextBodyContent);
        ...
        /** TransContextBodyContent _ref_id. */
        _ref_id?: "ref_id";

        /**
            * Creates a new TransContextBodyContent instance using the specified properties.
            * @param [properties] Properties to set
            * @returns TransContextBodyContent instance
            */
        static create(properties?: ITransContextBodyContent): TransContextBodyContent;

        /**
            * Encodes the specified TransContextBodyContent message. Does not implicitly {@link TransContextBodyContent.verify|verify} messages.
            * @param message TransContextBodyContent message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encode(message: ITransContextBodyContent, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Encodes the specified TransContextBodyContent message, length delimited. Does not implicitly {@link TransContextBodyContent.verify|verify} messages.
            * @param message TransContextBodyContent message or plain object to encode
            * @param [writer] Writer to encode to
            * @returns Writer
            */
        static encodeDelimited(message: ITransContextBodyContent, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
            * Decodes a TransContextBodyContent message from the specified reader or buffer.
            * @param reader Reader or buffer to decode from
            * @param [length] Message length if known beforehand
            * @returns TransContextBodyContent
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): TransContextBodyContent;

        /**
            * Decodes a TransContextBodyContent message from the specified reader or buffer, length delimited.
            * @param reader Reader or buffer to decode from
            * @returns TransContextBodyContent
            * @throws {Error} If the payload is not a reader or valid buffer
            * @throws {$protobuf.util.ProtocolError} If required fields are missing
            */
        static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): TransContextBodyContent;

        /**
            * Verifies a TransContextBodyContent message.
            * @param message Plain object to verify
            * @returns `null` if valid, otherwise the reason why it is not
            */
        static verify(message: { [k: string]: any }): (string|null);
        ...
        /**
            * Creates a TransContextBodyContent message from a plain object. Also converts values to their respective internal types.
            * @param object Plain object
            * @returns TransContextBodyContent
            */
        static fromObject(object: { [k: string]: any }): TransContextBodyContent;

        /**
            * Creates a plain object from a TransContextBodyContent message. Also converts values to other types if specified.
            * @param message TransContextBodyContent
            * @param [options] Conversion options
            * @returns Plain object
            */
        static toObject(message: TransContextBodyContent, options?: $protobuf.IConversionOptions): { [k: string]: any };

        /**
            * Converts this TransContextBodyContent to JSON.
            * @returns JSON object
            */
        toJSON(): { [k: string]: any };
}
