                ...
                describe("关联对象 ref_objs 同步NameObject数据",async()=>{
                    it("#业务流程测试",async()=>{
                        ...
                        for(let i=0;i<10;i++){
                            ...
                            let ref_objects : cyfs.Vec<cyfs.ObjectLink> = new cyfs.Vec([ new cyfs.ObjectLink(prev.calculate_id(),undefined),new cyfs.ObjectLink(prev2.calculate_id(),undefined)])
