...
export class AppLocalStatusDesc extends ProtobufDescContent {
    ...
    auto_update: boolean;
    constructor(id: DecAppId, status: AppLocalStatusCode, permissions: BuckyHashMap<BuckyString, PermissionNode>, quota: AppQuota, last_status_update_time?: JSBI, version?: string, web_dir?: ObjectId, sub_error?: SubErrorCode, auto_update?: boolean);
    type_info(): DescTypeInfo;
...
class CmdCode {
    ...
    quota?: AppQuota | undefined;
    auto_update?: boolean | undefined;
    constructor(code: AppCmdCode, add?: AddApp | undefined, install?: InstallApp | undefined, permission?: ModifyAppPermission | undefined, quota?: AppQuota | undefined, auto_update?: boolean | undefined);
...
export enum RouterEventCategory {
    TestEvent = "test_event",
    ZoneRoleChanged = "zone_role_changed"
}
...
export class OpEnvRequestor {
    ...
    get_dec_id(): ObjectId;
    get_category(): GlobalStateCategory;
    load(req: OpEnvLoadOutputRequest): Promise<BuckyResult<void>>;
    load_by_path(req: OpEnvLoadByPathOutputRequest): Promise<BuckyResult<void>>;
    create_new(req: OpEnvCreateNewOutputRequest): Promise<BuckyResult<void>>;
    lock(req: OpEnvLockOutputRequest): Promise<BuckyResult<void>>;
    get_current_root(req: OpEnvGetCurrentRootOutputRequest): Promise<BuckyResult<OpEnvGetCurrentRootOutputResponse>>;
    commit(req: OpEnvCommitOutputRequest): Promise<BuckyResult<OpEnvCommitOutputResponse>>;
    abort(req: OpEnvAbortOutputRequest): Promise<BuckyResult<void>>;
    ...
    insert_with_key(req: OpEnvInsertWithKeyOutputRequest): Promise<BuckyResult<void>>;
    ...
    reset(req: OpEnvResetOutputRequest): Promise<BuckyResult<void>>;
    list(req: OpEnvListOutputRequest): Promise<BuckyResult<OpEnvListOutputResponse>>;
}
...
export class GlobalStateStub {
    ...
    get_current_root(): Promise<BuckyResult<RootInfo>>;
...
export class SingleOpEnvStub {
    constructor(requestor: OpEnvRequestor, target?: ObjectId, dec_id?: ObjectId);
    create_new(content_type: ObjectMapSimpleContentType): Promise<BuckyResult<void>>;
    load(target: ObjectId): Promise<BuckyResult<void>>;
    load_by_path(path: string): Promise<BuckyResult<void>>;
    get_by_key(key: string): Promise<BuckyResult<ObjectId | undefined>>;
    insert_with_key(key: string, value: ObjectId): Promise<BuckyResult<void>>;
    ...
    get_current_root(): Promise<BuckyResult<ObjectId>>;
    update(): Promise<BuckyResult<ObjectId>>;
    commit(): Promise<BuckyResult<DecRootInfo>>;
    abort(): Promise<BuckyResult<void>>;
    next(step: number): Promise<BuckyResult<ObjectMapContentItem[]>>;
    reset(): Promise<BuckyResult<void>>;
    list(): Promise<BuckyResult<ObjectMapContentItem[]>>;
    metadata(): Promise<BuckyResult<ObjectMapMetaData>>;
}
export class PathOpEnvStub {
    constructor(requestor: OpEnvRequestor, target?: ObjectId, dec_id?: ObjectId);
    lock(path_list: string[], duration_in_millsecs: JSBI): Promise<BuckyResult<void>>;
    try_lock(path_list: string[], duration_in_millsecs: JSBI): Promise<BuckyResult<void>>;
    lock_impl(path_list: string[], duration_in_millsecs: JSBI, try_lock: boolean): Promise<BuckyResult<void>>;
    get_by_key(path: string, key: string): Promise<BuckyResult<ObjectId | undefined>>;
    create_new(path: string, key: string, content_type: ObjectMapSimpleContentType): Promise<BuckyResult<void>>;
    insert_with_key(path: string, key: string, value: ObjectId): Promise<BuckyResult<void>>;
    ...
    create_new_with_path(full_path: string, content_type: ObjectMapSimpleContentType): Promise<BuckyResult<void>>;
    insert_with_path(full_path: string, value: ObjectId): Promise<BuckyResult<void>>;
    ...
    get_current_root(): Promise<BuckyResult<DecRootInfo>>;
    update(): Promise<BuckyResult<DecRootInfo>>;
    commit(): Promise<BuckyResult<DecRootInfo>>;
    abort(): Promise<BuckyResult<void>>;
    list(path: string): Promise<BuckyResult<ObjectMapContentItem[]>>;
...
export class NONRequestorHelper {
    ...
    static decode_get_object_response(resp: Response): Promise<BuckyResult<NONGetObjectOutputResponse>>;
}
...
export class SharedCyfsStack {
    ...
    global_state_storage(category: GlobalStateCategory, path: string, content_type: ObjectMapSimpleContentType): StateStorage;
    global_state_storage_ex(category: GlobalStateCategory, path: string, content_type: ObjectMapSimpleContentType, target?: ObjectId, dec_id?: ObjectId): StateStorage;
}
...
class RouterHandlerItem {
    ...
    constructor(chain: RouterHandlerChain, category: RouterHandlerCategory, index: number, id: string, dec_id: Option<ObjectId>, filter: string, default_action: RouterHandlerAction, routine: Option<RouterHandlerAnyRoutine>);
...
export class RouterHandlerUnregisterItem {
    id: string;
    dec_id: Option<ObjectId>;
    constructor(chain: RouterHandlerChain, category: RouterHandlerCategory, id: string, dec_id: Option<ObjectId>);
    get_dec_id(): ObjectId | undefined;
...
export class RouterWSHandlerHandlerManagerImpl {
    ...
    static remove_handler(manager: RouterWSHandlerHandlerManagerImpl, chain: RouterHandlerChain, category: RouterHandlerCategory, id: string, dec_id: Option<ObjectId>): Promise<BuckyResult<boolean>>;
...
export class RouterHandlerWSHandlerManager {
    ...
    constructor(service_url: string, dec_id?: ObjectId | undefined);
    start(): void;
...
export class RouterWSHandlerResponseJsonCodec extends JsonCodec<RouterWSHandlerResponse> {
    decode_object(o: any): BuckyResult<RouterWSHandlerResponse>;
}
...
export class RouterHandlerManager {
    ...
    constructor(event_type: CyfsStackEventType, ws_url?: string, dec_id?: ObjectId | undefined);
...
export const Admin_DESC_TYPE_INFO: AdminDescTypeInfo;
...
export class AdminGlobalStateAccessModeData {
    ...
    constructor(category: GlobalStateCategory, access_mode: GlobalStateAccessMode);
...
export class AdminCommand {
    ...
    global_state_access_mode_data?: AdminGlobalStateAccessModeData | undefined;
    constructor(code: AdminCommandCode, global_state_access_mode_data?: AdminGlobalStateAccessModeData | undefined);
}
export class AdminDescContent extends ProtobufDescContent {
    target: DeviceId;
    cmd: AdminCommand;
    constructor(target: DeviceId, cmd: AdminCommand);
    type_info(): DescTypeInfo;
...
export class StateStorage {
    ...
    constructor(stack: SharedCyfsStack, category: GlobalStateCategory, path: string, content_type: ObjectMapSimpleContentType, target?: ObjectId, dec_id?: ObjectId);
    path(): string;
    stub(): SingleOpEnvStub;
    is_dirty(): boolean;
    set_dirty(dirty: boolean): void;
    init(): Promise<BuckyResult<[]>>;
    load(): Promise<BuckyResult<StorageOpData>>;
    save(): Promise<BuckyResult<[]>>;
    abort(): Promise<void>;
    abort_impl(): Promise<void>;
    commit_impl(): Promise<BuckyResult<[]>>;
    start_save(dur: number): void;
    stop_save(): void;
}
export class StateStorageMap {
    constructor(storage_: StateStorage);
    storage(): StateStorage;
    save(): Promise<BuckyResult<[]>>;
    abort(): Promise<void>;
    get(key: string): Promise<BuckyResult<ObjectId | undefined>>;
    set(key: string, value: ObjectId): Promise<BuckyResult<ObjectId | undefined>>;
    set_ex(key: string, value: ObjectId, prev_value: ObjectId | undefined, auto_insert: boolean): Promise<BuckyResult<ObjectId | undefined>>;
    insert(key: string, value: ObjectId): Promise<BuckyResult<void>>;
    remove(key: string): Promise<BuckyResult<ObjectId | undefined>>;
    remove_ex(key: string, prev_value?: ObjectId): Promise<BuckyResult<ObjectId | undefined>>;
    next(step: number): Promise<BuckyResult<[string, ObjectId][]>>;
    reset(): Promise<BuckyResult<void>>;
    list(): Promise<BuckyResult<[string, ObjectId][]>>;
...
export class StateStorageSet {
    ...
    insert(object_id: ObjectId): Promise<BuckyResult<boolean>>;
    remove(object_id: ObjectId): Promise<BuckyResult<boolean>>;
    next(step: number): Promise<BuckyResult<ObjectId[]>>;
    reset(): Promise<BuckyResult<void>>;
    list(): Promise<BuckyResult<ObjectId[]>>;
...
export class SyncRequestor {
    service_url: string;
    constructor(requestor: BaseRequestor, dec_id?: ObjectId | undefined);
    decode_sync_status_resp(resp: Response): Promise<BuckyResult<DeviceSyncStatus>>;
    sync_status(flush: boolean): Promise<BuckyResult<DeviceSyncStatus>>;
}
...
export class RouterEventRoutineT<REQ, RESP> implements RouterEventAnyRoutine {
    constructor(req_codec: JsonCodec<REQ>, resp_codec: JsonCodec<RESP>, listener: EventListenerAsyncRoutineT<RouterEventRequest<REQ>, RouterEventResponse<RESP>>);
    emit(param: string): Promise<BuckyResult<string>>;
}
export class RouterEventManager {
    ...
    constructor(event_type: CyfsStackEventType, ws_url?: string, dec_id?: ObjectId | undefined);
    get_dec_id(): ObjectId | undefined;
    add_test_event(id: string, index: number, routine: RouterEventTestEventRoutine): Promise<BuckyResult<void>>;
    add_zone_role_changed_event(id: string, index: number, routine: RouterEventZoneRoleChangedEventRoutine): Promise<BuckyResult<void>>;
    add_event<REQ, RESP>(id: string, index: number, category: RouterEventCategory, req_codec: JsonCodec<REQ>, resp_codec: JsonCodec<RESP>, routine: EventListenerAsyncRoutineT<RouterEventRequest<REQ>, RouterEventResponse<RESP>>): Promise<BuckyResult<void>>;
    remove_event(category: RouterEventCategory, id: string): Promise<BuckyResult<boolean>>;
}
...
export class RouterEventRequestJsonCodec<REQ> extends JsonCodec<RouterEventRequest<REQ>> {
    constructor(req_codec: JsonCodec<REQ>);
    encode_object(param: RouterEventRequest<REQ>): any;
    decode_object(o: any): BuckyResult<RouterEventRequest<REQ>>;
}
export class RouterEventResponseJsonCodec<RESP> extends JsonCodec<RouterEventResponse<RESP>> {
    constructor(resp_codec: JsonCodec<RESP>);
    encode_object(param: RouterEventResponse<RESP>): any;
    decode_object(o: any): BuckyResult<RouterEventResponse<RESP>>;
}
...
class RouterEventItem {
    ...
    dec_id: ObjectId | undefined;
    index: number;
    routine: RouterEventAnyRoutine;
    constructor(category: RouterEventCategory, id: string, dec_id: ObjectId | undefined, index: number, routine: RouterEventAnyRoutine);
    emit(param: string): Promise<BuckyResult<string>>;
    register(requestor: WebSocketRequestManager): Promise<BuckyResult<[]>>;
}
class RouterEventUnregisterItem {
    category: RouterEventCategory;
    id: string;
    dec_id?: ObjectId | undefined;
    constructor(category: RouterEventCategory, id: string, dec_id?: ObjectId | undefined);
    unregister(requestor: WebSocketRequestManager): Promise<BuckyResult<boolean>>;
}
class RouterWSEventManagerImpl {
    events: {
        [name: string]: RouterEventItem;
    };
    unregister_events: {
        [name: string]: RouterEventUnregisterItem;
    };
    session?: WebSocketSession;
    constructor();
    get_event(id: RouterEventId): RouterEventItem | undefined;
    add_event(event_item: RouterEventItem): Promise<BuckyResult<void>>;
    static remove_event(manager: RouterWSEventManagerImpl, category: RouterEventCategory, id: string, dec_id?: ObjectId): Promise<BuckyResult<boolean>>;
    remove_event_op(category: RouterEventCategory, id: string, dec_id?: ObjectId): RouterEventUnregisterItem;
    static on_event(manager: RouterWSEventManagerImpl, content: string): Promise<BuckyResult<Option<string>>>;
    static emit(event: RouterEventItem, param: string): Promise<BuckyResult<string>>;
    static on_session_begin(manager: RouterWSEventManagerImpl, session: WebSocketSession): Promise<void>;
    static register_all(manager: RouterWSEventManagerImpl, session: WebSocketSession): Promise<void>;
    static unregister_all(manager: RouterWSEventManagerImpl, session: WebSocketSession): Promise<void>;
    static on_session_end(manager: RouterWSEventManagerImpl, session: WebSocketSession): Promise<void>;
}
export class RouterWSEventManager {
    ...
    constructor(service_url: string);
    start(): void;
    add_event<REQ, RESP>(id: string, dec_id: ObjectId | undefined, index: number, category: RouterEventCategory, req_codec: JsonCodec<REQ>, resp_codec: JsonCodec<RESP>, routine: EventListenerAsyncRoutineT<RouterEventRequest<REQ>, RouterEventResponse<RESP>>): Promise<BuckyResult<void>>;
    remove_event(category: RouterEventCategory, id: string, dec_id?: ObjectId): Promise<BuckyResult<boolean>>;
}
export {};
