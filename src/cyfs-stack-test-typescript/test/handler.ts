...
// import {stack, stackInfo} from "../../common/utils/share";
export class PostObjectHandlerDefault  implements cyfs.RouterHandlerPostObjectRoutine {
    private device : string;
    private handlerId : string;
    private chain :string
    private stack:cyfs.SharedCyfsStack
    constructor(device:string,handlerId : string,chain:string,stack:cyfs.SharedCyfsStack){
        this.device = device;
        this.handlerId = handlerId;
        this.chain = chain ;
        this.stack = stack
