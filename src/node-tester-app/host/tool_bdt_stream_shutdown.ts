...
async function main() {
    ...
    const taskList = [
        "bdt_tcpstream_shutdown_both_local",
        "bdt_tcpstream_shutdown_both_remote",
        "bdt_tcpstream_shutdown_read_local",
        "bdt_tcpstream_shutdown_read_remote",
        "bdt_tcpstream_shutdown_write_local",
        "bdt_tcpstream_shutdown_write_remote",
        "bdt_udpstream_shutdown_both_local",
        "bdt_udpstream_shutdown_both_remote",
        "bdt_udpstream_shutdown_read_local",
        "bdt_udpstream_shutdown_read_remote",
        "bdt_udpstream_shutdown_write_local",
        "bdt_udpstream_shutdown_write_remote",
    ];
