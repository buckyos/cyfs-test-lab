...
async function main() {
    ...
    const taskList = [
        "BDT_removeNdcData",
        "NDN_BBR_TCP_File_Concurrent10_download20",
        "NDN_BBR_TCP_File_Concurrent10_download50",
        "NDN_BBR_TCP_File_Concurrent10_download100",
        "NDN_BBR_TCP_File_Concurrent10_upload20",
        "NDN_BBR_TCP_File_Concurrent10_upload50",
        "NDN_BBR_TCP_File_Concurrent10_upload100",
        "NDN_BBR_UDP_File_Concurrent10_download20",
        "NDN_BBR_UDP_File_Concurrent10_download50",
        "NDN_BBR_UDP_File_Concurrent10_download100",
        "NDN_BBR_UDP_File_Concurrent10_upload20",
        "NDN_BBR_UDP_File_Concurrent10_upload50",
        "NDN_BBR_UDP_File_Concurrent10_upload100",
        "NDN_BBR_TCP_File_Concurrent20_upload",
        "NDN_BBR_TCP_File_Concurrent50_upload",
        "NDN_BBR_TCP_File_Concurrent100_upload",
        "NDN_BBR_UDP_File_Concurrent20_upload",
        "NDN_BBR_UDP_File_Concurrent50_upload",
        "NDN_BBR_UDP_File_Concurrent100_upload",
    ];
