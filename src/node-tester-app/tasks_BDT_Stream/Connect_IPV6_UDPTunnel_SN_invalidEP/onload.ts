...
export async function TaskMain(_interface: TaskClientInterface) {
    let testcase_name = "Connect_IPV6_UDPTunnel_SN_invalidEP"
    ...
    let firstQA_answer= "";
    agentList = agentList.concat(await InitAgentData(testAgent,{ipv6:{udp:true}},"info",1,LabSnList,{},firstQA_answer,Resp_ep_type.default))
