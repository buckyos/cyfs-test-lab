...
export async function TaskMain(_interface: TaskClientInterface) {
    let testcaseName = "Connect_IPV6_TCPTunnel_SN_invalidEP"
    ...
    let firstQA_answer= "";
    agentList = agentList.concat(await InitAgentData(testAgent,{ipv6:{tcp:true,udp:true}},"info",1,LabSnList,{},firstQA_answer,Resp_ep_type.default))
