...
async function main() {
    ...
    //people.  //NamedObject
    //people.desc(). //NamedObjectDesc
    //people.body_expect(). //ObjectMutBody
    //people.signs(). //ObjectSigns
    let data = new cyfs.PeopleDecoder()
    new cyfs.PeopleDecoder().raw_decode(people.to_vec().unwrap()).unwrap();
}
