...
export async function TaskMain(_interface: TaskClientInterface) {
    ...
    for(let i =0;i<10;i++){
        await put_object(_interface,DMC_Download,DMC_Upload,stack_download,stack_upload);
    }
    // await test_file(_interface,DMC_Download,DMC_Upload,stack_download,stack_upload,100*1024,100*100);
    // await test_file(_interface,DMC_Download,DMC_Upload,stack_download,stack_upload,1*1024*1024,100*100);
    // await test_file(_interface,DMC_Download,DMC_Upload,stack_download,stack_upload,10*1024*1024,100*100);
    // await test_file(_interface,DMC_Download,DMC_Upload,stack_download,stack_upload,100*1024*1024,1000*100);
    // await test_file(_interface,DMC_Download,DMC_Upload,stack_download,stack_upload,1000*1024*1024,10000*100);
