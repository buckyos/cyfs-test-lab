...
export async function TaskMain(_interface: TaskClientInterface) {
    ...
    await test_file(_interface,DMC_Download,DMC_Upload,stack_download,stack_upload,100*1024);
    await test_file(_interface,DMC_Download,DMC_Upload,stack_download,stack_upload,1*1024*1024);
    await test_file(_interface,DMC_Download,DMC_Upload,stack_download,stack_upload,10*1024*1024);
