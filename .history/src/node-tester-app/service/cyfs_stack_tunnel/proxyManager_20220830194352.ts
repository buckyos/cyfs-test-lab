...
export class ProxyManager extends EventEmitter {
    ...
    constructor(_interface: ServiceClientInterface) {
        ...
        this.cache_path = {
            file_upload:path.join(this.log.dir(),`../${options.peer_name}_cache`,"file_upload"),
            file_download:path.join(this.log.dir(),`../${options.peer_name}_cache`,"file_download"),
            NamedObject:path.join(this.log.dir(),`../${options.peer_name}_cache`,"NamedObject")
        }
    }
