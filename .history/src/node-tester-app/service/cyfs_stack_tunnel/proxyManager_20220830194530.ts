...
export class ProxyManager extends EventEmitter {
    ...
    constructor(_interface: ServiceClientInterface) {
        ...
        this.cache_path = {
            file_upload:path.join(this.log.dir(),`../${this.peerName}_cache`,"file_upload"),
            file_download:path.join(this.log.dir(),`../${this.peerName}_cache`,"file_download"),
            NamedObject:path.join(this.log.dir(),`../${this.peerName}_cache`,"NamedObject")
        }
    ...
    init(stack_type: string): { err: ErrorCode, log?: string,peerName:string } {
        ...
        return { err: ErrorCode.succ, log: "start success",peerName:this.peerName }
    }
